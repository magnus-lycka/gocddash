...
from analysis.data_munging import document_filter, texttest_failure_group_by_stage, create_binary_test_index_list
...
class TestFileStorage(unittest.TestCase):
    def test_document_filtering(self):
        ...
        self.assertEqual(output, ["catalogue", "documentMetadata", 'eventsLog', 'exitcode', 'internalxml', 'primarypres', 'routingLog', 'stderr', 'catalogue', 'documentMetadata', 'eventsLog', 'exitcode', 'internalxml', 'primarypres', 'routingLog', "stderr"])
    ...
    def test_group_by(self):
        ...
        self.assertEqual(output, {34578: {2: [("new", "documentMetadata"), ("new", "internalxml")], 12: [("missing", "target")]}})
