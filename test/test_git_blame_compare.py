...
whitespace_html = """<div id="pipeline_header">
    <div class="entity_status_wrapper page_header">
        <ul class="entity_title">
            <!--<li><a href="/go/pipelines">Pipelines</a></li>-->
            <li class="name"><a href="/go/tab/pipeline/history/ct-t">ct-t</a></li>
            ...
            <div class="sub_tab_container_content">
                ...
                <div id="tab-content-of-checkins" class="material_revision_diff">
                    <div style="padding: 1em;">
                        ...
                        <div>
                            <div class="material_title">
                                <strong> Git - URL: ssh://git@git/internet/services/banana/banana.git, Branch:
                                    master</strong>
                            </div>
                            <table class="list_table material_modifications">
                                <tr>
                        ...
                        <div>
                            <div class="material_title">
                                <strong> Git - URL: ssh://git@git/internet/services/pineapple/pineapple.git, Branch:
                                    master</strong>
                            </div>
                            <table class="list_table material_modifications">
                                <tr>
...
class TestGitBlame(unittest.TestCase):
    ...
    def test_whitespace_html(self):
        ...
        git_blame_compare.go_request_comparison_html = MagicMock(return_value=whitespace_html)
        output = git_blame_compare.get_git_comparison(pipeline_name, current, comparison, 'banana')
        self.assertEqual(output, [
            ['banana.git', ' Git - URL: ssh://git@git/internet/services/banana/banana.git', '87cfcf8f4655d8e5f2713636df26820b0cbd0513', 'X Y <XY@asdf.com> 2015-11-02T11:51:11+01:00', 'Grapefruit'],
            ['pineapple.git', ' Git - URL: ssh://git@git/internet/services/pineapple/pineapple.git', '261d2d6c3f0290729d2a60952120b4736c6ad1a5', 'X Y <X.Y@asdf.com> 2016-07-14T05:31:31+02:00', 'Pear'],
            ['pineapple.git', ' Git - URL: ssh://git@git/internet/services/pineapple/pineapple.git', 'a6884dc475e20b8d69fbf588ad4aa9beef4c466e', 'X Y <X.Y@asdf.com> 2016-07-13T23:09:02+02:00', 'Kiwi']])
